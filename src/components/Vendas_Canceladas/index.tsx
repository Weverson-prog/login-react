...
export const VENDAS_CANCELADAS = ({ children }: { children: JSX.Element }) => {
    const auth = useAuth(); 
    ...
    const [container, setContainer] = useState<HTMLDivElement | null>(null);
     ...
     const optionsWithDisabled3 = [
         { label: 'DT.DEB.', value: 'DT.DEB.' },
         { label: 'DT.Venda', value: 'DT.Venda' },
         { label: 'NSU', value: 'NSU' },
         ...
         { label: 'Conta', value: 'Conta', disabled: false  },
     ];
