...
export const ANTECIPACOES = ({ children }: { children: JSX.Element }) => {
    const auth = useAuth(); 
...
<Column title="DT. VENDA"  dataIndex="DT_VENDA" key="DT_VENDA" render={(_: any, record: DataType) => (
    ...
    /> 
    <Column title="DATA PREVISTA"  dataIndex="DATA_PREVISTA" key="DATA_PREVISTA" render={(_: any, record: DataType) => (
      <Space size="middle">
          <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="INTERVALO"  dataIndex="INTERVALO" key="INTERVALO" render={(_: any, record: DataType) => (
      <Space size="middle">
          <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="% ANTECIPAÇÃO"  dataIndex="%_ANTECIPACAO" key="%_ANTECIPACAO" render={(_: any, record: DataType) => (
      <Space size="middle">
          <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    <Column title="VR ANTECIPAÇÃO"  dataIndex="VR_ANTECIPACAO" key="VR_ANTECIPACAO" render={(_: any, record: DataType) => (
      <Space size="middle">
          <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="VALOR DA VENDA"  dataIndex="VALOR_DA_VENDA" key="VALOR_DA_VENDA" render={(_: any, record: DataType) => (
      <Space size="large">
        <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="VR. ADMINISTRATIVA"  dataIndex="VR_ADMINISTRATIVA" key="VR_ADMINISTRATIVA" render={(_: any, record: DataType) => (
      <Space size="middle">
          <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="VALOR LÍQUIDO"  dataIndex="VALOR LIQUIDO" key="VALOR LIQUIDO" render={(_: any, record: DataType) => (
      <Space size="middle">
          <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="RO"  dataIndex="RO" key="RO" render={(_: any, record: DataType) => (
      <Space size="middle">
          <Input bordered={false} placeholder=""  
          />
      </Space> 
