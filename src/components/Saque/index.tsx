...
export const SAQUE = ({ children }: { children: JSX.Element }) => {
    const auth = useAuth(); 
  ...
  />
    ...
    /> 
    <Column title="SAQUE "  dataIndex="SAQUE" key="SAQUE" render={(_: any, record: DataType) => (
      <Space size="large">
       <Select   
    defaultValue="Selecione"
    style={{ 
...
<Table  dataSource={data}>
    ...
    <Column title="DATA LANÇAMENTO"  dataIndex="DATA_LANÇAMENTO" key="DATA_LANÇAMENTO" render={(_: any, record: DataType) => (
      <Space size="middle">
    ...
    /> 
    <Column title="TIPO DE LANÇAMENTO"  dataIndex="TIPO_DE_LANÇAMENTO" key="TIPO_DE_LANÇAMENTO" render={(_: any, record: DataType) => (
      <Space size="large">
        <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    />
  <Column title="ID INTERNO"  dataIndex="ID_INTERNO" key="ID_INTERNO" render={(_: any, record: DataType) => (
      <Space size="large">
        <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="PARCELA"  dataIndex="PARCELA" key="PARCELA" render={(_: any, record: DataType) => (
      <Space size="large">
        <Input bordered={false} placeholder=""  
          />
      </Space> 
