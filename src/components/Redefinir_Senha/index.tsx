...
export const REDEFINIR_SENHA = ({ children }: { children: JSX.Element }) => {
    const auth = useAuth(); 
  ...
  const onChangeDate: DatePickerProps['onChange'] = (date, dateString) => {
    ...
    <Column title="SENHA"  dataIndex="SENHA" key="SENHA" render={(_: any, record: DataType) => (
      <Space size="large">
   ...
   /> 
    <Column title="CONFIRMAR SENHA "  dataIndex="CONFIRMAR_SENHA" key="CONFIRMAR_SENHA" render={(_: any, record: DataType) => (
   ...
   <br></br>   
    <Button type="primary"  icon={'SALVAR'} size={size} style={{width: 100}} />    
   <br></br>
