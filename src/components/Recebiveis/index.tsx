...
export const RECEBIVEIS = ({ children }: { children: JSX.Element }) => {
    const auth = useAuth(); 
...
<Table  dataSource={data}>
    ...
    <Column title="DATA PREV."  dataIndex="DATA_PREV" key="DATA_PREV" render={(_: any, record: DataType) => (
      <Space size="middle">
    ...
    /> 
    <Column title="MÊS"  dataIndex="MES" key="MES" render={(_: any, record: DataType) => (
      <Space size="large">
        <Input bordered={false} placeholder=""  
          />
      </Space> 
