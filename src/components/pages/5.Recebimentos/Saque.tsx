...
export function Saque() {
  ...
  function mostrardetalhado() {
    let element = document.getElementById("showDetalhado");
    if (element?.style.display == "none") {
      element.style.display = "block";
    }
  }
                  ...
                  render={(_: any, record: DataType) => (
                    <Space size="middle">
                      <Radio.Group defaultValue="" buttonStyle="solid">
                        <Radio.Button onClick={mostrardetalhado} value="a">
                          DETALHADO
                        </Radio.Button>
                        <Radio.Button onClick={mostrarsimples} value="b">
                          SIMPLES
                        </Radio.Button>
                      </Radio.Group>
                    </Space>
