...
export function OpeSynthetic({ opeSyntheticList }: OpeSyntheticProps) {
  ...
  const opeSyntheticData: OpeSynthecticData[] = opeSyntheticList.map((opeSynthetic, index) => ({
    key: index,
...
export function OpeAnalytic({ opeAnalyticList }: OpeAnalyticProps) {
  ...
  const opeAnalyticData: OpeAnalyticData[] = opeAnalyticList.map((opeAnalytic, index) => ({
    key: index,
