            ...
            <Row>
              <Col flex="auto">
                ...
                <h2 style={{
                  ...
                  fontFamily: 'arial',
                  fontSize: '20px'
                }}>A conciliação de cartões é uma prática essencial para a saúde financeira do negócio.<br></br>
                  Sem o controle da receitas recebidas por meio dos cartões de crédito e débito,<br></br> fica impossível prever o fluxo de caixa futuro e saber o montante que foi cobrado de
                  taxas pelas empresas de cartões.</h2>
              </Col>
            </Row>
          </article>
        </Content>
