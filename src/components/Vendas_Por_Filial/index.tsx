...
export const VENDAS_POR_FILIAL = ({ children }: { children: JSX.Element }) => {
    const auth = useAuth(); 
    ...
    const optionsWithDisabled = [
        ...
        { label: 'Não Conciliados', value: 'Não Conciliados', disabled: false },
    ];
    ...
    const optionsWithDisabled3 = [
        ...
        { label: 'Detalhe', value: 'Detalhe', disabled: false },
    ];
...
<Card >
    <div>
        ...
        <Table pagination={false} dataSource={data}>
                ...
                <Column title="NSU" dataIndex="NSU" key="NSU"
                    render={(_: any, record: DataType) => (
        ...
        <div style={{ margin: 0, padding: 0,}}>
            <Table pagination={false} dataSource={data}>
                    ...
                    <Column title="Visão" dataIndex="Visao" key="Visao"
                        render={(_: any, record: DataType) => (
                            <Space size="middle" style={{ marginRight: '5px', width: '100%', }}>
