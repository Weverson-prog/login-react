...
export const CREDITO_EM_CONTA = ({ children }: { children: JSX.Element }) => {
    const auth = useAuth(); 
...
<Table  dataSource={data}>
    ...
    /> 
    <Column title="NOME FANTASIA"  dataIndex="NOME_FANTASIA" key="NOME_FANTASIA" render={(_: any, record: DataType) => (
      <Space size="large">
       <Input bordered={false} placeholder=""  
          />
  </Space>
  ...
  <Column title="CONTRATO"  dataIndex="CONTRATO" key="CONTRATO" render={(_: any, record: DataType) => (
    ...
    /> 
    <Column title="NR. CONTA"  dataIndex="NR_CONTA" key="NR_CONTA" render={(_: any, record: DataType) => (
      <Space size="large">
        <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="NR. BANCO"  dataIndex="NR_BANCO" key="NR_BANCO" render={(_: any, record: DataType) => (
      <Space size="large">
        <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="VALOR CONTA"  dataIndex="VALOR_CONTA" key="VALOR_CONTA" render={(_: any, record: DataType) => (
      <Space size="large">
        <Input bordered={false} placeholder=""  
          />
      </Space> 
