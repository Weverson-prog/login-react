...
import {InputNumber,  Space, Table, Card, Checkbox, Select, Col, Row, Menu, Layout, MenuProps, Input,  Button, notification, DatePicker,  } from 'antd';
...
export const CONCILIACAO = ({ children }: { children: JSX.Element }) => {
    const auth = useAuth(); 
  ...
  const onChangeDate: DatePickerProps['onChange'] = (date, dateString) => {
          ...
          <Content
            ...
            <Card style={{  backgroundColor: '#f0f5ff', margin: '20px 24px 0', overflow: 'initial' }}>
              ...
              <Card.Grid style={gridStyle}>
                <Card  title={'OPERADORA'} extra={<Button type="primary" icon={<BarChartOutlined />} size={"small"} />} style={{  fontFamily:'arial',  maxWidth: '100%'}}>
    ...
    />
    <Column dataIndex="PENDENTE" key="PENDENTE" render={(_: any, record: DataType) => (
      <Space size="small">
       <Checkbox onChange={onChange}>PENDENTE</Checkbox>
      </Space> 
    )}
    /> 
    <Column dataIndex="SEARCH_BUTTON" key="SEARCH_BUTTON" render={(_: any, record: DataType) => (
      <Space size="small">
    ...
    <Table style={{margin: '10px', width: '100%', height: '50%'}}pagination={false} dataSource={data}>
    <Column title="FILIAL"  dataIndex="FILIAL" key="FILIAL" render={(_: any, record: DataType) => (
      <Space size="small">
      <Select   
   ...
   /> 
    <Column title="BANDEIRA"  dataIndex="BANDEIRA" key="BANDEIRA" render={(_: any, record: DataType) => (
       ...
       /> 
         ...
         /> 
         <Column title="CONTRATOS"  dataIndex="CONTRATOS" key="CONTRATOS" render={(_: any, record: DataType) => (
      <Space size="small">
      <Select   
   defaultValue="Selecione"
   style={{ 
 ...
 />
   ...
   <Table showHeader={false} style={{margin: '10px', maxWidth: '100%', height: '50%'}}pagination={false} dataSource={data}>
    <Column title=""  dataIndex="" key="" render={(_: any, record: DataType) => (
      <Space size="small">
        <InputNumber prefix="R$" style={{ maxWidth: '100%' }} /> <span></span> <Button type="primary" shape="round" icon={'CONCILIAR'} size={size} style={{maxWidth: 150}} />
     </Space> 
   )}
   /> 
   </Table>
<br></br>
   <Card style={{  maxWidth: '100%'}}>
              ...
              <Column   dataIndex="SEARCH_BAR" key="SEARCH_BAR" render={(_: any, record: DataType) => (
      <Space size="small">
<Search placeholder="Pesquisar" onSearch={onSearch} style={{ maxWidth: 200 }} />
  ...
  <Table style={{ width: '100%', margin: '10px'}}>
   <Column title="NOME"  dataIndex="NOME" key="NOME" render={(_: any, record: DataType) => (
      <Space size="small">
...
<Input bordered={false} placeholder=""  
    ...
    /> 
    <Column title="OPE"  dataIndex="OPE" key="OPE" render={(_: any, record: DataType) => (
      <Space size="small">
<Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="NSU"  dataIndex="NSU" key="NSU" render={(_: any, record: DataType) => (
      <Space size="small">
<Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="AUTOR"  dataIndex="AUTOR" key="AUTOR" render={(_: any, record: DataType) => (
      <Space size="small">
<Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="PRC"  dataIndex="PRC" key="PRC" render={(_: any, record: DataType) => (
      <Space size="small">
<Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="VALOR"  dataIndex="VALOR" key="VALOR" render={(_: any, record: DataType) => (
      <Space size="small">
<Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    <Card.Grid style={gridStyle}>
    <Card title={'ERP'} extra={<Button type="primary" icon={<BarChartOutlined />} size={"small"} />} style={{ fontFamily:'arial',width: '100%'}}>
