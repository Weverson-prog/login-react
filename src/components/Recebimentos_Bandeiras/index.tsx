...
export const RECEBIMENTOS_BANDEIRAS = ({ children }: { children: JSX.Element }) => {
    const auth = useAuth(); 
...
<Column title="DT. PAGAMENTO"  dataIndex="DT_PAGAMENTO" key="DT_PAGAMENTO" render={(_: any, record: DataType) => (
      <Space size="middle">
    ...
    /> 
    <Column title="ESTABELECIMENTO"  dataIndex="ESTABELECIMENTO" key="ESTABELECIMENTO" render={(_: any, record: DataType) => (
      <Space size="middle">
          <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="VALOR BRUTO"  dataIndex="VALOR_BRUTO" key="VALOR_BRUTO" render={(_: any, record: DataType) => (
      <Space size="middle">
          <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="VALOR LIQUIDO"  dataIndex="VALOR_LIQUIDO" key="VALOR_LIQUIDO" render={(_: any, record: DataType) => (
      <Space size="middle">
          <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="TAXAS ADM."  dataIndex="TAXAS_ADM" key="TAXAS_ADM" render={(_: any, record: DataType) => (
      <Space size="large">
        <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="TAXAS ANTECIPAÇÃO"  dataIndex="TAXAS_ANTECIPACAO" key="TAXAS_ANTECIPACAO" render={(_: any, record: DataType) => (
      <Space size="middle">
          <Input bordered={false} placeholder=""  
          />
      </Space> 
