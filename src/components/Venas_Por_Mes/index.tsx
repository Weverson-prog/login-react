...
import { Affix, Col, Row, Menu, Layout, MenuProps, Input, Space, Button, Divider, notification, Card,Table, } from 'antd';
...
export const VENDAS_POR_MES = ({ children }: { children: JSX.Element }) => {
    const auth = useAuth(); 
