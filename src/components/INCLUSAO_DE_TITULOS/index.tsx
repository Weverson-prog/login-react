...
export const INCLUSAO_DE_TITULOS = ({ children }: { children: JSX.Element }) => {
    const auth = useAuth(); 
  ...
  const onChangeDate: DatePickerProps['onChange'] = (date, dateString) => {
    ...
    <Column title="DATA INCIAL"  dataIndex="DATA_INICIAL" key="DATA_INICIAL" render={(_: any, record: DataType) => (
      <Space size="small">
    ...
    <Column title="DATA DE VENCIMENTO INICIAL"  dataIndex="DATA_DE_VENCIMENTO_INICIAL" key="DATA_DE_VENCIMENTO_INICIAL" render={(_: any, record: DataType) => (
      <Space size="small">
          <DatePicker onChange={onChangeDate} />
      </Space> 
    )}
    /> 
    <Column title="DATA DE VENCIMENTO FINAL"  dataIndex="DATA_DE_VENCIMENTO_FINAL" key="DATA_DE_VENCIMENTO_FINAL" render={(_: any, record: DataType) => (
      <Space size="small">
          <DatePicker onChange={onChangeDate} />
      </Space> 
    )}
 ...
 />
   ...
   /> 
    <Column title="OPERAÇÃO"  dataIndex="OPERACAO" key="OPERACAO" render={(_: any, record: DataType) => (
      <Space size="small">
      <Select   
   defaultValue="Selecione"
   style={{ 
