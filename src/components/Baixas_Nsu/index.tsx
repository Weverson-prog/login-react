...
export const BAIXAS_NSU = ({ children }: { children: JSX.Element }) => {
    const auth = useAuth(); 
  ...
  /> 
    ...
    /> 
    <Column title="EMPRESA"  dataIndex="EMPRESA" key="EMPRESA" render={(_: any, record: DataType) => (
      <Space size="large">
       <Select   
    defaultValue="Selecione"
    style={{ 
...
<Table  dataSource={data}>
    ...
    /> 
    <Column title="DT. CRED"  dataIndex="DT_CRED" key="DT_CRED" render={(_: any, record: DataType) => (
      <Space size="large">
        <Input bordered={false} placeholder=""  
          />
      </Space> 
  ...
  <Column title="BANDEIRA"  dataIndex="BANDEIRA" key="BANDEIRA" render={(_: any, record: DataType) => (
    ...
    /> 
    <Column title="INVOICE"  dataIndex="INVOICE" key="INVOICE" render={(_: any, record: DataType) => (
      <Space size="large">
        <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="STS"  dataIndex="STS" key="STS" render={(_: any, record: DataType) => (
      <Space size="large">
        <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="BCO"  dataIndex="BCO" key="BCO" render={(_: any, record: DataType) => (
      <Space size="large">
        <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="AG"  dataIndex="AG" key="AG" render={(_: any, record: DataType) => (
      <Space size="large">
        <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="CC"  dataIndex="CC" key="CC" render={(_: any, record: DataType) => (
      <Space size="large">
        <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="R$ VENDA"  dataIndex="R$_VENDA" key="R$_VENDA" render={(_: any, record: DataType) => (
      <Space size="large">
        <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="R$ PAGO"  dataIndex="R$_PAGO" key="R$_PAGO" render={(_: any, record: DataType) => (
      <Space size="large">
        <Input bordered={false} placeholder=""  
          />
      </Space> 
    ...
    /> 
    <Column title="R$ CONCIL"  dataIndex="R$_CONCIL" key="R$_CONCIL" render={(_: any, record: DataType) => (
      <Space size="large">
        <Input bordered={false} placeholder=""  
          />
      </Space> 
